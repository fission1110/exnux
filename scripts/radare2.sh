#!/bin/bash
V_RADARE2_URL=https://github.com/radareorg/radare2/releases/download/5.8.8/radare2_5.8.8_amd64.deb
V_RADARE2_DEV_URL=https://github.com/radareorg/radare2/releases/download/5.8.8/radare2-dev_5.8.8_amd64.deb
